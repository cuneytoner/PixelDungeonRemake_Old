...
import com.coner.pixeldungeon.support.Ads;
...
public class PixelDungeon extends Game {
	...
	public PixelDungeon() {
		...
		// remix 23.1.alpha
		com.watabou.utils.Bundle.addAlias(
				com.coner.pixeldungeon.mobs.guts.SuspiciousRat.class,
				"com.coner.pixeldungeon.mobs.guts.Wererat");
		// remix 23.2.alpha
		com.watabou.utils.Bundle.addAlias(
				com.coner.pixeldungeon.items.guts.weapon.melee.Claymore.class,
				"com.coner.pixeldungeon.items.guts.weapon.melee.BroadSword");
		// remix 24
		com.watabou.utils.Bundle.addAlias(
				com.coner.pixeldungeon.items.accessories.Bowknot.class,
				"com.coner.pixeldungeon.items.accessories.BowTie");
		// remix 24
		com.watabou.utils.Bundle.addAlias(
	...
	public static String activeMod() {
		return Preferences.INSTANCE.getString(Preferences.KEY_ACTIVE_MOD, ModdingMode.ReMake);
	}
